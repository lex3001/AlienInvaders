...
' GUIDs initialization, Copyright (c) 1998, Patrice Scribe
' c_dfDIJokstick2 not tested
...
Public c_dfDIJoystick2 As DIDATAFORMAT  ' Not tested !
...
Public Sub GUID_Initialize()
    If mbInitialized Then Exit Sub
    mbInitialized = True
