...
static func get_sound_definitions() -> Array[Dictionary]:
	return [
		...
		{"name": "ALIENF_LOOP", "file": "res://assets/audio/mixkit-sci-fi-spaceship-in-cosmos-2734.wav", "copies": 1, "loop": true},
		{"name": "GAME_OVER", "file": "res://assets/audio/mixkit-retro-arcade-game-over-470.wav", "copies": 1},
		{"name": "CAMERA", "file": "res://assets/audio/camera.wav", "copies": 1},
		{"name": "PLANET_APPEAR", "file": "res://assets/audio/tromosm-radioactive-sci-fi-sound-276454.mp3", "copies": 1}
	]
