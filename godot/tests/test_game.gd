...
func test_game_state():
	...
	assert_equal(game.game_state, Constants.GameState.MENU, "Initial state is MENU")

	game.change_state(Constants.GameState.PLAYING)
	assert_equal(game.game_state, Constants.GameState.PLAYING, "State can be changed to PLAYING")

	game.change_state(Constants.GameState.PAUSED)
	assert_equal(game.game_state, Constants.GameState.PAUSED, "State can be changed to PAUSED")
